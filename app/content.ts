...
export const siteContent = {
  nl: {
    ...
    home: {
      ...
      statement:
        "Rust, scherpte en professioneel handelen — juist wanneer veiligheid het belangrijkst is.",
      ...
      services: [
        {
          ...
          description:
            "Professioneel toezicht, toegangscontrole en een zichtbare veiligheidsaanwezigheid voor locaties, medewerkers en bezoekers.",
        },
        {
          number: "02",
          title: "Luchthavenbeveiliging",
          description:
            "Ervaring met luchtvaartbeveiliging op Schiphol, security checks en werken volgens strikte veiligheidsprocedures.",
        },
        {
          number: "03",
          title: "Toezicht & handhaving",
          description:
      ...
      experience: [
        ...
        {
          year: "HBO",
          role: "Bachelor Expert Openbare Orde en Veiligheid",
          company: "Afgeronde bacheloropleiding",
        },
        {
          year: "DIPLOMA",
          role: "Beveiliger 2",
          company: "Vakgerichte beveiligingsopleiding",
        },
      ],
  ...
  en: {
    ...
    home: {
      ...
      statement:
        "Calm, vigilance, and professional action — especially when safety matters most.",
      ...
      services: [
        {
          ...
          title: "Site security",
          description:
            "Professional supervision, access control, and a visible security presence for locations, employees, and visitors.",
        },
        {
          number: "02",
          title: "Aviation security",
          description:
            "Experience in aviation security at Amsterdam Airport Schiphol, security checks, and working under strict safety procedures.",
        },
        {
          number: "03",
      ...
      experience: [
        ...
        {
          year: "BACHELOR",
          role: "Public Order and Safety",
          company: "Completed higher professional education degree",
        },
        {
          year: "DIPLOMA",
          role: "Dutch Security Officer Level 2",
          company: "Professional security qualification",
        },
      ],
      skillsTitle: "Skills",
      skills: [
